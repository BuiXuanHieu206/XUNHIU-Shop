...
namespace SV20T1020375.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <param name="minPrice">Mức giá nhỏ nhất trong khoảng giá cần tim</param>
        /// <param name="maxPrice">Mức giá lớn nhất trong khoảng giá cần tìm (0 nếu không hạn chế mức giá lớn nhât)</param>
        /// <returns></returns>
