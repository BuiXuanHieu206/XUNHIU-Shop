        ...
        public int Add(Supplier data)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var sql = @"if exists(select * from Suppliers where Email = @Email)
                            ...
                            begin
                                insert into Suppliers(SupplierName, ContactName, Province, Address, Phone, Email, BirthDate)
                                values(@SupplierName, @ContactName, @Province, @Address, @Phone, @Email, @BirthDate);
